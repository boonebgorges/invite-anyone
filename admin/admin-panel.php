				...
				<tbody>
					...
					<tr>
						...
						<?php else : ?>
							...
							<td><input type="text" id="cloudsponge-key" name="invite_anyone[cloudsponge_account_key]" value="
							<?php
							if ( $account_key ) {
								echo esc_attr( $account_key );
							} elseif ( isset( $_GET['cloudsponge-key'] ) ) {
								echo esc_attr( $_GET['cloudsponge-key'] ); }
							?>
							" />
							<?php if ( $account_key ) : ?>
