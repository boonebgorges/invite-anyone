...
if (array_key_exists('service', $_GET)) {
  ...
  $output = CSImport::begin_import($_GET['service'], $username, $password, 'http://hardg.com/darlene/members/' );
...
<script type="text/javascript">
  ...
  window.opener.location = '<?php echo bp_displayed_user_domain() . BP_INVITE_ANYONE_SLUG ?>?import_id=<?=$import_id?>';
<?php if (isset($url)) {  ?>
